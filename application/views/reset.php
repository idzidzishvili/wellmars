            ...
            <h3><?php echo lang('recoverPassword');?></h3>
               ...
               <?php echo form_open('auth/reset_process', array('class' => 'tab-pane active col-12 p-a0', 'id' => 'reset')); ?>                     
                  <div class="form-group">
                     <label class="font-weight-700"><?php echo lang('pwd')?> <span class="text-danger">*</span></label>
                     <input name="password" class="form-control" placeholder="<?php echo lang('pwd')?>" type="password">
                     <small style="color:red"><?php echo form_error('password'); ?></small>
                  </div>
                  <div class="form-group">
                     <label class="font-weight-700"><?php echo lang('pwd2')?> <span class="text-danger">*</span></label>
                     <input name="confirmPassword" class="form-control" placeholder="<?php echo lang('pwd2')?>" type="password">
