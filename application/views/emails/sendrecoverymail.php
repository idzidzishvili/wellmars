...
<body>
   <div style="max-width:800px; padding:20px;margin:auto;text-align: left; font-size: 16px">
      ...
      <br><br>
      <a href="<?php echo site_url('auth/recover/'.$userid.'/'.$recoveryString);?>" style="padding:10px 30px; background-color: #ff6d34; color: white; text-decoration: none; border-radius: 4px"> Recover password </a>
   </div>
</body>
</html>