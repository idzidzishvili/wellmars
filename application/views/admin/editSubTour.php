	...
	<div class="container-fluid">
		...
		<?php echo form_open(base_url('admin/editsubtour/'.$id), array("enctype" => "multipart/form-data")); ?>
			<div class="form-row">
				...
				<div class="form-group col-md-9">
					<select class="form-control form-control-sm" id="tourId" name="tourId">
						...
						<?php foreach ($tourCategories as $tourCat) : ?>
							<option value="<?php echo $tourCat->id; ?>" <?php echo $tourCat->id==$tour->tour_id?' selected':'';?>>
				...
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourName_ge" name="subTourName_ge" value="<?php echo $tour->tourname_ge; ?>" autocomplete="off" placeholder="ქართულად">
					<small style="color:red"><?php echo form_error('subTourName_ge'); ?></small>
				</div>
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourName_en" name="subTourName_en" value="<?php echo $tour->tourname_en; ?>" autocomplete="off" placeholder="ინგლისურად">
					<small style="color:red"><?php echo form_error('subTourName_en'); ?></small>
				</div>
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourName_ru" name="subTourName_ru" value="<?php echo $tour->tourname_ru; ?>" autocomplete="off" placeholder="რუსულად">
				...
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourDuration_ge" name="subTourDuration_ge" value="<?php echo $tour->duration_ge; ?>" autocomplete="off" placeholder="ქართულად">
					<small style="color:red"><?php echo form_error('subTourDuration_ge'); ?></small>
				</div>
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourDuration_en" name="subTourDuration_en" value="<?php echo $tour->duration_en; ?>" autocomplete="off" placeholder="ინგლისურად">
					<small style="color:red"><?php echo form_error('subTourDuration_en'); ?></small>
				</div>
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourDuration_ru" name="subTourDuration_ru" value="<?php echo $tour->duration_ru; ?>" autocomplete="off" placeholder="რუსულად">
				...
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourDest_ge" name="subTourDest_ge" value="<?php echo $tour->destination_ge; ?>" autocomplete="off" placeholder="ქართულად">
					<small style="color:red"><?php echo form_error('subTourDest_ge'); ?></small>
				</div>
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourDest_en" name="subTourDest_en" value="<?php echo $tour->destination_en; ?>" autocomplete="off" placeholder="ინგლისურად">
					<small style="color:red"><?php echo form_error('subTourDest_en'); ?></small>
				</div>
				<div class="form-group col-md-3">
					<input type="text" class="form-control form-control-sm" id="subTourDest_ru" name="subTourDest_ru" value="<?php echo $tour->destination_ru; ?>" autocomplete="off" placeholder="რუსულად">
				...
				<div class="form-group col-md-9">
					<textarea type="text" class="form-control form-control-sm summernote" id="subTourDescr_ge" name="subTourDescr_ge" ><?php echo $tour->description_ge; ?></textarea>
				...
				<div class="form-group col-md-9">
					<textarea type="text" class="form-control form-control-sm summernote" id="subTourDescr_en" name="subTourDescr_en" ><?php echo $tour->description_en; ?></textarea>
				...
				<div class="form-group col-md-9">
					<textarea type="text" class="form-control form-control-sm summernote" id="subTourDescr_ru" name="subTourDescr_ru" ><?php echo $tour->description_ru; ?></textarea>
					...
					<tbody id="imgcontainer">
						<?php foreach ($tourimages as $image): ?>
							<tr>
								...
								<td><a href="<?php echo base_url('admin/deleteImage/'.$image->id.'/'.$tour->id);?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"> წაშლა</i></a></td>
							</tr>
						<?php endforeach; ?>
						<tr>
