...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	...
	<div class="container-fluid">
      ...
      <?php echo form_open(base_url('admin/addgallery')); ?>
         <div class="form-row">
            <div class="form-group col-md-3 mb-0">
               <label for="galleryname_ge">გალერიის დასახელება ქართულად</label>
            </div>
            <div class="form-group col-md-9">
               <input type="text" class="form-control form-control-sm" id="galleryname_ge" name="galleryname_ge" value="<?php echo set_value('galleryname_ge'); ?>" autocomplete="off" >
            ...
            <div class="form-group col-md-9">
               <input type="text" class="form-control form-control-sm" id="galleryname_en" name="galleryname_en" value="<?php echo set_value('galleryname_en'); ?>" autocomplete="off" >
            ...
            <div class="form-group col-md-9">
               <input type="text" class="form-control form-control-sm" id="galleryname_ru" name="galleryname_ru" value="<?php echo set_value('galleryname_ru'); ?>" autocomplete="off" >
               <small style="color:red"><?php echo form_error('galleryname_ru'); ?></small>
            </div>

            <div class="form-group col-lg-7">
               <button type="submit" class="btn btn-primary"><i class="fa fa-save mr-2"></i>გალერიის დამატება</button>
            </div>
         </div>
      <?php echo form_close(); ?>
	</div>
